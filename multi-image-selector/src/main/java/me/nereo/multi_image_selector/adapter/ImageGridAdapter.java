...
public class ImageGridAdapter extends BaseAdapter {
     ...
     * @param resultList
     */
    public void setRefreshSelected2(ArrayList<String> resultList) {
//        for(String path : resultList){
//            Image image = getImageByPath(path);
//            if(image != null){
//                mSelectedImages.add(image);
...
//            notifyDataSetChanged();
//        }
        ArrayList<Image> mI=new ArrayList<>();
        for(Image image:mSelectedImages){
            if(!resultList.contains(image.path)){
                mI.add(image);
            }
        }
        mSelectedImages.removeAll(mI);
    ...
    public void setmOnCheckItemListener(OnCheckItemListener mOnCheckItemListener) {
        this.mOnCheckItemListener = mOnCheckItemListener;
    }
        ...
        holder.indicator.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mOnCheckItemListener!=null){
                    mOnCheckItemListener.onCheck(i);
                }
            }
        });
        return view;
        ...
        void bindData(final Image data){
            ...
            if(showSelectIndicator){
                ...
                if(mSelectedImages.contains(data)){
                    // 设置选中状态
                    indicator.setImageResource(R.drawable.contacts_address_book_icon_select_selected);
//                    mask.setVisibility(View.VISIBLE);
                }else{
                    // 未选择
                    indicator.setImageResource(R.drawable.contacts_address_book_icon_select_normal);
