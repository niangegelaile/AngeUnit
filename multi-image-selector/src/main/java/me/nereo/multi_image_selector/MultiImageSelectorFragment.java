...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        try {
            mCallback = (Callback) getActivity();//设置回调
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mImageAdapter.setmOnCheckItemListener(new ImageGridAdapter.OnCheckItemListener() {
            @Override
...
//                }
                    ...
                    public void run() {
                        ...
                        if (index == 0) {
                            ...
                            if (null != folder) {
                                ...
                                if(mCallback!=null){
                                    mCurrentFoldImages= (ArrayList<Image>) folder.images;
                                    mCallback.onImageFold((ArrayList<Image>) folder.images);
                                }
            ...
            if(mode == MODE_MULTI) {
                if (resultList.contains(image.path)) {
                    ...
                    if(selectImageCount() == resultList.size()){
                        Toast.makeText(getActivity(), "你最多能添加"+selectImageCount()+"张照片", Toast.LENGTH_SHORT).show();
                        return;
                    }
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
            if (data != null) {
                if (data.getCount() > 0) {
                    ...
                    if(mCallback!=null){
                        mCurrentFoldImages= (ArrayList<Image>) images;
                        mCallback.onImageFold((ArrayList<Image>) images);
                    }
                    if(resultList != null && resultList.size()>0){
                        mImageAdapter.setDefaultSelected(resultList);
                    }
    ...
    public interface Callback{
        ...
        void onImageFold(ArrayList<Image> images);
    }
